...
--
CREATE TABLE public.coin_verse (id integer NOT NULL, name text);

--
-- Name: coin_verse_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
CREATE SEQUENCE public.coin_verse_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE TABLE public.internal_notes_plain_text (text text, type integer);
...
--
CREATE TABLE public.material_color (material integer, color character(7));
...
--
CREATE SEQUENCE public.mint_region_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE TABLE public.overlord_titles (overlord_id integer, title_id integer);
...
--
CREATE TABLE public.person_explorer_custom_sorting ("position" integer, person integer);
...
--
CREATE SEQUENCE public.project_items_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.province_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.treasure_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.treasure_item_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE TABLE public.type_coin_verse (type integer, coin_verse integer);
...
--
CREATE SEQUENCE public.web_page_block_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE TABLE public.web_page_group (id integer NOT NULL, name text);

--
-- Name: web_page_group_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
CREATE SEQUENCE public.web_page_group_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.web_page_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.web_page_image_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
ALTER TABLE
    ONLY public.coin_verse
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.coin_verse_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.notes_id_seq' :: regclass);
...
--
ALTER TABLE
    ONLY public.mint_region
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.mint_region_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.project_id_seq' :: regclass);

--
-- Name: project_items id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.project_items
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.project_items_id_seq' :: regclass);

--
-- Name: province id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.province
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.province_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.settings_id_seq' :: regclass);
...
--
ALTER TABLE
    ONLY public.treasure
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.treasure_id_seq' :: regclass);

--
-- Name: treasure_item id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.treasure_item
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.treasure_item_id_seq' :: regclass);
...
--
ALTER TABLE
    ONLY public.web_page
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.web_page_id_seq' :: regclass);

--
-- Name: web_page_block id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.web_page_block
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.web_page_block_id_seq' :: regclass);

--
-- Name: web_page_group id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.web_page_group
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.web_page_group_id_seq' :: regclass);

--
-- Name: web_page_image id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.web_page_image
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.web_page_image_id_seq' :: regclass);
...
--
ALTER TABLE
    ONLY public.app_user_privilege
ADD
    CONSTRAINT app_user_privilege_pkey PRIMARY KEY (app_user, privilege);
...
ALTER TABLE
    ONLY public.coin_verse
ADD
    CONSTRAINT coin_verse_pkey PRIMARY KEY (id);
...
--
ALTER TABLE
    ONLY public.internal_notes_plain_text
ADD
    CONSTRAINT internal_notes_plain_text_type_key UNIQUE (type);
...
ALTER TABLE
    ONLY public.mint_region
ADD
    CONSTRAINT mint_region_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.note
ADD
    CONSTRAINT note_property_property_id_key UNIQUE (property, property_id);
...
ALTER TABLE
    ONLY public.comment
ADD
    CONSTRAINT notes_text_key UNIQUE (text);
...
--
ALTER TABLE
    ONLY public.person_color
ADD
    CONSTRAINT person_color_person_key UNIQUE (person);

--
-- Name: person_explorer_custom_sorting person_explorer_custom_sorting_person_key; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.person_explorer_custom_sorting
ADD
    CONSTRAINT person_explorer_custom_sorting_person_key UNIQUE (person);
...
ALTER TABLE
    ONLY public.treasure_item
ADD
    CONSTRAINT treasure_item_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.treasure
ADD
    CONSTRAINT treasure_name_key UNIQUE (name);
...
ALTER TABLE
    ONLY public.web_page_block
ADD
    CONSTRAINT web_page_block_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.web_page_group
ADD
    CONSTRAINT web_page_group_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.web_page_image
ADD
    CONSTRAINT web_page_image_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.mint
ADD
    CONSTRAINT fk_province FOREIGN KEY (province) REFERENCES public.province(id);
...
ALTER TABLE
    ONLY public.internal_notes_plain_text
ADD
    CONSTRAINT internal_notes_plain_text_type_fkey FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.person_color
ADD
    CONSTRAINT person_color_person_fkey FOREIGN KEY (person) REFERENCES public.person(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.person_explorer_custom_sorting
ADD
    CONSTRAINT person_explorer_custom_sorting_person_fkey FOREIGN KEY (person) REFERENCES public.person(id);
...
ALTER TABLE
    ONLY public.project_items
ADD
    CONSTRAINT project_items_project_fkey FOREIGN KEY (project) REFERENCES public.project(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.settings
ADD
    CONSTRAINT settings_parent_fkey FOREIGN KEY (parent) REFERENCES public.settings(id);
...
ALTER TABLE
    ONLY public.treasure_item
ADD
    CONSTRAINT treasure_item_cointype_fkey FOREIGN KEY (cointype) REFERENCES public.type(id);
...
ALTER TABLE
    ONLY public.treasure_item
ADD
    CONSTRAINT treasure_item_dynasty_fkey FOREIGN KEY (dynasty) REFERENCES public.dynasty(id);
...
ALTER TABLE
    ONLY public.treasure_item
ADD
    CONSTRAINT treasure_item_material_fkey FOREIGN KEY (material) REFERENCES public.material(id);
...
ALTER TABLE
    ONLY public.treasure_item
ADD
    CONSTRAINT treasure_item_mint_region_fkey FOREIGN KEY (mint_region) REFERENCES public.mint_region(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.treasure_item
ADD
    CONSTRAINT treasure_item_nominal_fkey FOREIGN KEY (nominal) REFERENCES public.nominal(id);
...
ALTER TABLE
    ONLY public.treasure_item
ADD
    CONSTRAINT treasure_item_treasure_fkey FOREIGN KEY (treasure) REFERENCES public.treasure(id) ON DELETE CASCADE;

--
-- Name: type_coin_verse type_coin_verse_coin_verse_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.type_coin_verse
ADD
    CONSTRAINT type_coin_verse_coin_verse_fkey FOREIGN KEY (coin_verse) REFERENCES public.coin_verse(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.type_coin_verse
ADD
    CONSTRAINT type_coin_verse_type_fkey FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.web_page
ADD
    CONSTRAINT web_page_author_fkey FOREIGN KEY (author) REFERENCES public.app_user(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.web_page_block
ADD
    CONSTRAINT web_page_block_image_fkey FOREIGN KEY (image) REFERENCES public.web_page_image(id);
...
ALTER TABLE
    ONLY public.web_page_block
ADD
    CONSTRAINT web_page_block_page_fkey FOREIGN KEY (page) REFERENCES public.web_page(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.web_page_block
ADD
    CONSTRAINT web_page_block_parent_fkey FOREIGN KEY (parent) REFERENCES public.web_page_block(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.web_page
ADD
    CONSTRAINT web_page_image_fkey FOREIGN KEY (image) REFERENCES public.web_page_image(id);
...
ALTER TABLE
    ONLY public.web_page
ADD
    CONSTRAINT web_page_page_group_fkey FOREIGN KEY (page_group) REFERENCES public.web_page_group(id);
