    ...
    <div class="political-map ui">
        ...
        <Sidebar>
            ...
            <template #tools>
                <list-selection-tools
                    :hide-select-all-button="true"
                    :all-selected="allMintsSelected"
                    :none-selected="mint_locations_mixin_noneSelected"
        ...
        <div class="center-ui center-ui-bottom">
            <TimelineSlideshowArea
                ...
                :timeline-value="raw_timeline.value"
                :valid="timelineValid"
                :share-link="shareLink"
                :timeline-active="timelineActive"
                timeline-name="political-map"
                @input="timeChanged"
            ...
            >
                <template #left>
                    <map-settings-box
                        ...
                        @reset="resetSettings"
                    >
                        <LabeledInputContainer label="Kreisgröße">
                            <slider
                                name="maxRadius"
        ...
        <Sidebar side="right">
            ...
            <template #tools>
                <ListSelectionTools
                    :hide-select-all-button="true"
                    :all-selected="false"
                    :none-selected="selectedRulers.length === 0"
                    @select-all="() => { }"
                    @unselect-all="clearRulerSelection"
                />
            </template>
            <ruler-list
                :selected-unavailable="selectedUnavailableRulers"
                :unavailable="unavailableRulers"
                :items="availableRulers"
                :selected-ids="selectedRulers"
